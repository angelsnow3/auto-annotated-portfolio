...
sections:
  - elementId: ''
    colors: colors-f
    backgroundSize: full
    text: "###### 垂直领域专家：\n\n深耕通信/教育/金融三大高壁垒行业，主导从0到1的30+大型项目体系\n\n###### 界面架构专家：\n\n专精复杂系统UI设计，构建企业级设计规范，交付效率提升40%+ \_\n\n###### 全链璐体验设计：\n\n主导用户研究信息架构交互原型全流程，完成8+完整项目闭环验证\n\n###### AI场景设计先锋：\n\nAR眼镜信息可视化与巡检机器人界面设计，降低人工核验成本20% \_\n\n###### 数据驱动决策者：\n\nA/B测试推动K12产品留存率提升15%，工业界面方案间接降本30% \_\n\n###### 品牌体验构建师：\n\n打造10+行业标杆品牌体系，MWC世界移动通信大会设计连续4年获奖\n\n前沿技术探索者：\n\nWeb3全生态设计布局（交易所/钱包/DApp），定义区块链可视化\n\n嗨，我是一名资深用户体验设计师。我出生并成长于这个世界，这也是我的基地。我现在是一名自由职业者，曾是这个、那个、超级大牌。当我不编码、写作或创作时，我会吃麦片。我有一只狗，看看她[@mygod](https://www.stackbit.com/)。\n\n"
    media:
      type: ImageBlock
