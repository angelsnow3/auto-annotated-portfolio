...
sections:
  - elementId: ''
    ...
    text: >
      ...
      涉及通信领域、在线教育行业及金融类产品。UI项目从0到1项目经验7年+，累计大型项目30+，负责过用户量超千万级产品的设计；擅长复杂系统的界面设计、数据可视化、工具用户体验优化。这是我的基地，曾是这个、那个、超级大牌。当我不设计创作时，我会去逛博物馆和旅行。了解我[@mygod](https://www.stackbit.com/)
    media:
      type: ImageBlock
