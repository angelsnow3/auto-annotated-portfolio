...
sections:
  - elementId: ''
    ...
    text: >
      ...
      涉及通信领域、在线教育行业及金融类产品。参与从0到1大型项目30+，负责过用户量超千万级产品的设计；擅长复杂系统的界面设计、数据可视化、工具用户体验优化。设计工作可内容涵盖了用户研究、UI、UX、品牌设计、视觉设计工作、产品外观效果设计、大型展会、IP周边和线下活动等多个设计领域。


      这是我的基地。当我不设计创作时，我会去逛博物馆和旅行。
    media:
      type: ImageBlock
